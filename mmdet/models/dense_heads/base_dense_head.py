...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def get_bboxes(self,
        ...
        for img_id in range(len(img_metas)):
            ...
            # 将一个batch中单张图片不同层的cls和bbox组成list返回
    ...
    def onnx_export(self,
        ...
        # 一个batch中同个层的cls和bbox组成list中的元素
        # len(list)=5
        ...
        # 对每一层的bbox和cls单独处理,其中每一层对应同一batch的汇总
        for cls_score, bbox_pred, score_factors, priors in zip(
            ...
            if nms_pre > 0:
                ...
                # bbox_pred [1, 5776, 4]
                # transformed_inds [1,1000]
                # batch中不同图片通过调整索引值单独操作，类似于batch_nms
        ...
        # print(batch_score_factors.shape)
        # assert False
        # onnx topk是在每层中去top1000
        # input 608 //8=76  //16=38  //8=19  //16=10 //32=5
        # L3=76^2=5776  L4=38^2=1444  L5=19^2=361  L6=10^2=100  L5=5^2=25
        # after top1000 1000+1000+361+100+25=2486
        # torch.Size([1, 2486, 4])
        # torch.Size([1, 2486, 80])
        # torch.Size([1, 2486])
